...
<div class="flex-grow flex items-center justify-center p-4">
    <div class="w-[340px] sm:w-[392px] bg-white p-8 rounded-2xl shadow-modal border-0">
        ...
        <img class="mx-auto mt-6" src="https://images.web3auth.io/ws-trademark-light.svg" alt="web3auth footer">
    </div>
</div>